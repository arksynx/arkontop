...
cmdBox.PlaceholderText = "Allostra loaded"
cmdBox.Text = ""
...
--Discord Invite / i had to add it to the top so i can call the function easier.
local notificationShown = false
local TweenService = game:GetService("TweenService")
local discordInvite = "https://discord.gg/allostra"
...
local function createNotification()
	...
	label.Text = "Allostra Discord Server"
